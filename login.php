                ...
                <div class="col-lg-8 col-12">
                    <div class="col-12">
                        <div class="comments-form">
                            <h2>Login to Your TSDC Account</h2>
                            <!-- Contact Form -->
                            <form class="form" method="post" id="login_form" action="">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-4 col-12">
                                        <div class="form-group">
                                            <p style="text-align: start;">Don't have an account? Sign up from <a href="signup.php" style="color: #1a76d1;"><u>here.</u></a></p>
                                        </div>
                                    </div>
                                    <div class="col-12">
